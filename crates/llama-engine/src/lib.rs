...
///
/// Implements [`Iterator`] to allow consuming tokens as they are generated.
/// In a real implementation, this might be backed by a channel or a generator.
pub struct TokenStream {
    tokens: std::collections::VecDeque<TokenId>,
}
