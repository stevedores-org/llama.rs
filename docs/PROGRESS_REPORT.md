...
| State | Count | PRs |
|-------|-------|-----|
| Merged | 6 | #3, #16, #17, #18, #22, #24 |
| Open | 6 | #19, #21, #23, #25, #26, #27 |
...
2. **PR pile-up** — 6 open PRs; some overlapping (e.g. #25, #26, #27 all touch tokenizer/engine). Triage and merge or close to avoid conflict churn.
...
4. **Milestone A in progress** — scaffold, tokenizer, KV cache done; sampling (PR #21 open), tiny model forward, CLI remaining.
